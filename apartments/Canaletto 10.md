...
| FIELD | VALUE |
|---|---|
| Nome appartamento | Canaletto 10 |
| Nome annuncio | Bright Design Room • A/C • Work Desk •Blue Metro3' |
| Indirizzo completo | Via Canaletto 10, Milano (MI), 20133 |
| Descrizione palazzo (colore/numero piani totale) | palazzo storico di 5 piani, grigio e giallo |
| Descrizione porta condominiale | un portone di legno |
| Piano | l'appartamento si trova al primo piano |
| Presenza ascensore | purtroppo no |
| Metratura totale | circa 45/50 metri quadri |
| Numero camere da letto | 1 |
| Numero bagni | 1 |
| Numero soggiorni | 1 |
| Numero massimo ospiti | 4 |
| Numero letti totali | 2 un letto matrimoniale e un divano letto matrimoniale |
| Numero matrimoniali | 2 un letto matrimoniale e un divano letto matrimoniale |
| Numero singoli | 0 |
| Divano letto presente (marca e tipologia) | sì è presente in sala non so la marca ma assicuro che è molto comodo |
| Presenza balcone | presente un pratico balcone dove godersi dei piacevoli momenti all'aria aperta |
| Giardino privato | no |
...
| FIELD | VALUE |
|---|---|
| Link accesso all'appartamento | l'invio delle istruzioni di check in viene inviato circa 48 ore prima dell'arrivo degli ospiti e questo è il link che viene inviato: https://milanoholidayhomes.kross.travel/guest/check-in-instructions?tag=2c7c96b1788fc51bb661cebe6fe3a4d7 |
...
| Codice portone | Per aprire il primo portone di legno: citofonate al numero 71, poi schiacciate il campanello 🔔, attendete qualche secondo e si aprirà il primo portone. poi arriveranno alla scala d e citofoneranno all'interno 44 |
| Codice keybox | 4200 |
| Posizione keybox | sullo stipite della porta di casa |
| Nome sul citofono | il cin esposto cioè il seguente codice alfanumerico IT015146C28HF8ZLI9 |
| Numero interno | 44 |
| Piano corretto | entrati dal portone del civico, seguire dritti fino in fondo e sulla destra troverete un portone di una scala, la scala d suonerete all'interno 44 e la porta si aprirà, poi salire al primo piano e la porta di casa è quella segnata col numero 44 |
...
| FIELD | VALUE |
|---|---|
| Link istruzioni check out | https://milanoholidayhomes.kross.travel/guest/check-out-instructions?tag=2c7c96b1788fc51bb661cebe6fe3a4d7 |
...
| Aria condizionata | presente in camera da letto uno split |
| Riscaldamento | ci sono i caloriferi regolabili tramite termovalvole |
...
| Caffè | non presente in appanon presente in appartamento , se serve i guest possono acquistarlo al supermercato piu' vicino e li rimborseremortamento , se serve i guest possono acquistarlo al supermercato piu' vicino e li rimborseremo |
...
| Divano letto | è presente un comodo e spazioso divano letto matrimoniale a scomparsa in modo tale da risparmiare spazio e concedere l'adeguato comfort agli ospiti |
| Smart TV | sì |
| Dimensione TV | circa 40 pollici |
| Sedie disponibili | 4 sedie sul tavolo da pranzo |
| Aria condizionata | presente uno split |
...
| Phon | presente |
| Caldaia | no |
| Scaldabagno | si, marca ariston presente di fianco all frigorifero della cucina. |
...
| FIELD | VALUE |
|---|---|
| Aria condizionata | si, l'appartamento gode di un impianto di aria condizionata con split |
| Numero split/fancoil | 1, in camera in grado di raffreddare tutto l'ambiente |
| Riscaldamento autonomo | no, è condominiale regolabile tramite termovalvole sui caloriferi. spiega che in caso di freddo questa cosa non dipende da noi ma dal condominio che stabilise le temperature in base alle normative antinquinamento comunali. specificca solo se il guest ha molto freddo che possono utilizzare gli split dell'aria condizionata per fonti ulteriori di calore. |
| Tipo riscaldamento | condominiale regolabile con termovalvole sui caloriferi |
...
| FIELD | VALUE |
|---|---|
| Nome Wi-Fi | Vodafone-C05480747 |
| Password Wi-Fi | pX7yPcg7sHYHAt4Y |
...
| Quadro elettrico | entrati in sala guardare a destra dietro la porta del soggiorno |
| Contatore elettrico | se salta la corrente, bisogna spiegare al guest che probabilmente ha utilizzato troppi elettrodomestici insieme e per riattivare la corrente deve alzare la leva del contatore generale che si trova in casa all'ingresso |
...
| Salta corrente | se salta la corrente, bisogna spiegare al guest che probabilmente ha utilizzato troppi elettrodomestici insieme e per riattivare la corrente deve alzare la leva del contatore generale che si trova in casa, rtrando nell'appartamento nell'armadio a destra. il seguente link https://drive.google.com/file/d/1RVRiLoCnDLugTOMtayiUX95kRTGM2AgC/view?usp=drivesdk |
