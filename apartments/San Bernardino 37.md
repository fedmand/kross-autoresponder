...
| FIELD | VALUE |
|---|---|
| Nome appartamento | San Bernardino 37 |
| Nome annuncio | design luxury apartment•centre of the city•AIRPORT |
| Indirizzo completo | Via San Bernardino 37, Bergamo (24121) se l'ospite ha solo inviato la richiesta di prenotazione scrivi soltanto il nome della via senza civico, mentre dopo aver effettuato e confermato la prenotazione comunicaglielo pure per esteso. |
| Descrizione porta condominiale | Un portone di legno |
| Piano | l'appartamento si trova al piano Numero 2 |
| Presenza ascensore | no |
| Metratura totale | La casa si sviluppa interamente su un unico piano e ha una superficie interna di circa 66 metri quadrati, |
| Numero camere da letto | La casa dispone di una camera da letto matrimoniale |
| Numero bagni | la casa dispone di un bagno |
| Numero soggiorni | La casa dispone di un ampio disimpegno centrale dotato di un divano letto matrimoniale e di una poltrona letto singola |
...
| FIELD | VALUE |
|---|---|
| Link accesso all'appartamento | l'invio delle istruzioni di check in viene inviato circa 48 ore prima dell'arrivo degli ospiti e questo è il link che viene inviato https://milanoholidayhomes.kross.travel/guest/check-in-instructions?tag=d1b9d3d04d52e72659daf02ecb3cc4e6 |
...
| Dove buttare immondizia | il locale immondizia si trova superato il portone di ingresso |
...
| Letti singoli | c'è una poltrona letto singola |
| Tipologia di materassi | non conosco la marca esatta ma sono tutti molto comodi |
| Armadio | c'è un grande armadio nella camera da letto |
| Comodini | Ci sono due comodini in ogni stanza |
...
| Riscaldamento | Il riscaldamento è canalizzato come per l'aria condizionata |
...
| Tappetino bagno | sì |
| Scaldasalviette | no |
| Lavatrice | sì qui il link di come far funzionare la lavatrice (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/VdcXnU9LJqI?si=BqtF_JpJ3hV8NcKY |
| Stendino | sì |
...
| Piano induzione | no |
| Piano gas | sì |
| Forno | sì qui il link di come far funzionare il forno (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/020Mz6-JrE4?si=NSrw6SYje9_ExD1c |
| Microonde | no |
| Lavastoviglie | sì qui il link di come far funzionare la lavastoviglie (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/fPh-UvdBVzA?si=oKIkFQNkXp3LHyxH |
| Frigorifero | sì |
| Congelatore | sì |
| Bollitore | sì |
| Macchina caffè | sì |
...
| FIELD | VALUE |
|---|---|
| Divano | sì è presente un comodo divano letto matrimoniale |
| Divano letto | sì è presente un comodo divano letto matrimoniale |
...
| FIELD | VALUE |
|---|---|
| Lavatrice | si, qui il link di come far funzionare la lavatrice (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/VdcXnU9LJqI?si=enDaITA4J9P973Su |
| Asciugatrice | no |
| Ferro da stiro | sì |
| Asse da stiro | sì |
| Aspirapolvere | no |
...
| FIELD | VALUE |
|---|---|
| Nome Wi-Fi | vodafone wi-fi 6 station |
| Password Wi-Fi | HFFPczfmmM2XadZc |
| Router posizione | si trova in sala di fianco al televisore, qui il link di come trovare il wi-fi (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/wXCvb9MgB80?si=FIqzpNp5ISiR-c1S |
...
| Contatore elettrico | se salta la corrente, bisogna spiegare al guest che probabilmente ha utilizzato troppi elettrodomestici insieme e per riattivare la corrente deve alzare la leva del contatore generale che si trova dove ci sono le scale del secondo piano allega questo link che mostra il video di come trovare il contatore (specifica loro di alzare il contatore con la leva abbassata) https://youtu.be/Ied9z6S858U?si=mx8XC2yax25CPZNt |
...
| Taxi convenzionato | Spiega loro che non abbiamo un taxi convenzionato ma Il numero principale per chiamare un taxi a Bergamo è +39 035 451 9090, disponibile 24 ore su 24. |
...
| Aria condizionata non funziona | bisogna attivre il trermostato qui il link di come farlo funzionare (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/-5gXmTmkRyE?si=KcyejoLnyDvOiczQ |
