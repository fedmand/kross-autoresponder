...
| FIELD | VALUE |
|---|---|
| Nome appartamento | Palazzi 7 |
| Nome annuncio | 5 guests-A/c-Central station6min walk-PortaVenezia |
| Indirizzo completo | Via Lazzaro Palazzi, 7, Milano (MI) 20131 |
| Descrizione palazzo (colore/numero piani totale) | Palazzo storico di colore arancio |
| Descrizione porta condominiale | una porta di legno |
| Piano | l'appartamento si trova al secondo piano |
| Presenza ascensore | no, purtroppo non è presente |
| Metratura totale | circa 55 metri quadri |
...
| FIELD | VALUE |
|---|---|
| Link accesso all'appartamento | l'invio delle istruzioni di check in viene inviato circa 48 ore prima dell'arrivo degli ospiti e questo è il link che viene inviato: https://milanoholidayhomes.kross.travel/guest/check-in-instructions?tag=0cc991d269718bcd8c11050c09d2be5e |
...
| Self check-in | si, il check in avviene tramite keybox dopo aver sbloccato il portone condominiale perchè il locker si trova sulla porta di casa |
| Check-in in presenza | no |
| Codice portone | 163 |
| Codice keybox | 3318 |
| Posizione keybox | affianco alla porta di casa |
| Piano corretto | entrati dal civico superare il primo cancello nero e girare a destra salire due piani di scale e la porta di casa è quella più vicna alla rampa di scale che salgono al terzo piano ma guardare sempre le info di accesso https://milanoholidayhomes.kross.travel/guest/check-in-instructions?tag=0cc991d269718bcd8c11050c09d2be5e |
...
| FIELD | VALUE |
|---|---|
| Link istruzioni check out | https://milanoholidayhomes.kross.travel/guest/check-out-instructions?tag=0cc991d269718bcd8c11050c09d2be5e |
...
| FIELD | VALUE |
|---|---|
| Numero camere | 1 ma il soggiorno è ben diviso da una porta che garantiscono molta privacy |
...
| Letti singoli | una poltrona letto singola in camera |
...
|---|---|
| Cucina completa | sì |
| Piano induzione | si, qui il link di come far funzionare i fornelli (da inviare solo se il guest richiede espressamente come funziona il funzionamento: https://youtu.be/Dn-zIxtBUA4?si=UBPmW9s8mnaYgoN6 |
| Microonde | sì |
| Lavastoviglie | sì, presente |
...
| FIELD | VALUE |
|---|---|
| Lavatrice | presente in appartamento |
| Asciugatrice | no |
| Ferro da stiro | sì |
| Asse da stiro | sì |
| Phon | sì |
...
| FIELD | VALUE |
|---|---|
| Nome Wi-Fi | SKYWIFI_DCDTI |
| Password Wi-Fi | 33rqUTxaLwJMtA |
| Router posizione | in salotto, di fianco alla televisione |
| Procedura reset router | spegnere il modem e staccare e riattaccare la spina della corrente provando poi, dopo averlo riattaccato a riaccenderlo. nel caso in cui il disservizio continuasse voglio che sia LLM, sapendo che è un modem sky wifi a inviare una proceedura efficace di reset |
...
| Contatore elettrico | se salta la corrente, bisogna spiegare al guest che probabilmente ha utilizzato troppi elettrodomestici insieme e per riattivare la corrente deve alzare la leva del contatore generale che si trova in casa, appena entrati subito sulla sinistra come mostrato nel video https://youtu.be/CPcr08ZMi90?si=p-VGoFnk4UAbOKaY |
...
|---|---|
| Ascensore | no |
| Rampe | due piani di scale per ragiungere l'apartamento |
...
| Wi-Fi non funziona | spegnere il modem e staccare e riattaccare la spina della corrente provando poi, dopo averlo riattaccato a riaccenderlo. nel caso in cui il disservizio continuasse voglio che sia LLM, sapendo che è un modem sky wifi a inviare una proceedura efficace di reset |
